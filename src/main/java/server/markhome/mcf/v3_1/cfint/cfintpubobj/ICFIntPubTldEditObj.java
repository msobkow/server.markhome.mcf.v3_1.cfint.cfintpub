// Description: Java 25 Public Instance Edit Object interface for CFInt Tld.
...
public interface ICFIntPubTldEditObj
	extends ICFIntPubTldObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFIntPubTldObj.
	 */
	ICFIntPubTldObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFIntPubTldObj.
	 */
	ICFIntPubTldObj getOrigAsTld();
	 ...
	 */
	ICFIntPubTldObj create();

	/*
	 *	Update the instance.
	 */
	ICFIntPubTldEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFIntPubTldEditObj deleteInstance();
