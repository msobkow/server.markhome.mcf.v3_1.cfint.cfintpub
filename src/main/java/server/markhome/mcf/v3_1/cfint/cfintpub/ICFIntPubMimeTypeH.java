// Description: Java 25 public interface for a MimeType history object
...
/**
 *	ICFIntPubMimeTypeH provides access to public history records matching the CFIntPubMimeType object change history.
 */
public interface ICFIntPubMimeTypeH
{
	...
	public ICFIntPubMimeTypeHPKey getPubPKey();
	public void setPubPKey( ICFIntPubMimeTypeHPKey pkey );
