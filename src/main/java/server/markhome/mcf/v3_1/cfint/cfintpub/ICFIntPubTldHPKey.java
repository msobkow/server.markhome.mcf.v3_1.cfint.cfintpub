// Description: Java 25 public interface for a Tld history primary key object
...
/**
 *	ICFIntPubTldHPKey Public History Primary Key interface for Tld has CodeVis Public, meaning that any user interface or referencing schema can access it.
 *		requiredId	Required object attribute Id. */
public interface ICFIntPubTldHPKey
{
