// Description: Java 25 public interface for a MinorVersion record implementation
...
/**
 *	ICFIntPubMinorVersion persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFIntPubMinorVersion
{
