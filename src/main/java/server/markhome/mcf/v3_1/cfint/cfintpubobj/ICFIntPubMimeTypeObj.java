// Description: Java 25 Object interface for CFIntPub MimeType.
...
public interface ICFIntPubMimeTypeObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFIntPubMimeType.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFIntPubMimeTypeObj instance which should be subsequently referenced.
	 */
	ICFIntPubMimeTypeObj realise();
	 ...
	 *
	 *	@return	ICFIntPubMimeTypeObj the reference to the cached or read (realised) instance.
	 */
	ICFIntPubMimeTypeObj read();
	 ...
	 *	@return	ICFIntPubMimeTypeObj the reference to the cached or read (realised) instance.
	 */
	ICFIntPubMimeTypeObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this MimeType instance.
	 *
	 *	@return	The newly locked ICFIntPubMimeTypeEditObj edition of this instance.
	 */
	ICFIntPubMimeTypeEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFIntPubMimeTypeEditObj edition of this instance.
	 */
	ICFIntPubMimeTypeEditObj getEdit();

	/**
	 *	Get the current edition of this MimeType instance as a ICFIntPubMimeTypeEditObj.
	 *
	 *	@return	The ICFIntPubMimeTypeEditObj edition of this instance.
	 */
	ICFIntPubMimeTypeEditObj getEditAsMimeType();

	/**
	 *	Get the ICFIntPubMimeTypeTableObj table cache which manages this instance.
	 *
	 *	@return	ICFIntPubMimeTypeTableObj table cache which manages this instance.
	 */
	ICFIntPubMimeTypeTableObj getMimeTypeTable();
	...
	/**
	 *	Get the ICFIntPubMimeType instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFIntPubMimeType instance which currently backs this object.
	 */
	ICFIntPubMimeType getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFIntPubMimeType value );
	 ...
	 *	@return	ICFIntPubMimeType instance which currently backs this object.
	 */
	ICFIntPubMimeType getMimeTypeRec();
