// Description: Java 25 public interface for a TopProject record implementation
...
/**
 *	ICFIntPubTopProject persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFIntPubTopProject
{
	...
	public void setPubTopProject( ICFIntPubTopProject src );
	public void set( ICFIntPubTopProjectH src );
	public void setPubTopProject( ICFIntPubTopProjectH src );
