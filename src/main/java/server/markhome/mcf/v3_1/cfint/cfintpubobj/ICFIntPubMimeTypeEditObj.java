// Description: Java 25 Public Instance Edit Object interface for CFInt MimeType.
...
public interface ICFIntPubMimeTypeEditObj
	extends ICFIntPubMimeTypeObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFIntPubMimeTypeObj.
	 */
	ICFIntPubMimeTypeObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFIntPubMimeTypeObj.
	 */
	ICFIntPubMimeTypeObj getOrigAsMimeType();
	 ...
	 */
	ICFIntPubMimeTypeObj create();

	/*
	 *	Update the instance.
	 */
	ICFIntPubMimeTypeEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFIntPubMimeTypeEditObj deleteInstance();
