// Description: Java 25 Object interface for CFIntPub License.
...
public interface ICFIntPubLicenseObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFIntPubLicense.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFIntPubLicenseObj instance which should be subsequently referenced.
	 */
	ICFIntPubLicenseObj realise();
	 ...
	 *
	 *	@return	ICFIntPubLicenseObj the reference to the cached or read (realised) instance.
	 */
	ICFIntPubLicenseObj read();
	 ...
	 *	@return	ICFIntPubLicenseObj the reference to the cached or read (realised) instance.
	 */
	ICFIntPubLicenseObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this License instance.
	 *
	 *	@return	The newly locked ICFIntPubLicenseEditObj edition of this instance.
	 */
	ICFIntPubLicenseEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFIntPubLicenseEditObj edition of this instance.
	 */
	ICFIntPubLicenseEditObj getEdit();

	/**
	 *	Get the current edition of this License instance as a ICFIntPubLicenseEditObj.
	 *
	 *	@return	The ICFIntPubLicenseEditObj edition of this instance.
	 */
	ICFIntPubLicenseEditObj getEditAsLicense();

	/**
	 *	Get the ICFIntPubLicenseTableObj table cache which manages this instance.
	 *
	 *	@return	ICFIntPubLicenseTableObj table cache which manages this instance.
	 */
	ICFIntPubLicenseTableObj getLicenseTable();
	...
	/**
	 *	Get the ICFIntPubLicense instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFIntPubLicense instance which currently backs this object.
	 */
	ICFIntPubLicense getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFIntPubLicense value );
	 ...
	 *	@return	ICFIntPubLicense instance which currently backs this object.
	 */
	ICFIntPubLicense getLicenseRec();
