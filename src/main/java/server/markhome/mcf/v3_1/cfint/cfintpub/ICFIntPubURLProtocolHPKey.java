// Description: Java 25 public interface for a URLProtocol history primary key object
...
/**
 *	ICFIntPubURLProtocolHPKey Public History Primary Key interface for URLProtocol has CodeVis Public, meaning that any user interface or referencing schema can access it.
 *		requiredURLProtocolId	Required object attribute URLProtocolId. */
public interface ICFIntPubURLProtocolHPKey
{
