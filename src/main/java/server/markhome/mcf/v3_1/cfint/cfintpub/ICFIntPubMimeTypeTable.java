...
// Description: Java 25 public DbIO interface for MimeType.
...
/*
 *	CFIntPubMimeTypeTable public database interface for MimeType has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFIntPubMimeTypeTable
{
