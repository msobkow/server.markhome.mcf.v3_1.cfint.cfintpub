// Description: Java 25 public interface for a License history primary key object
...
/**
 *	ICFIntPubLicenseHPKey Public History Primary Key interface for License has CodeVis Public, meaning that any user interface or referencing schema can access it.
 *		requiredId	Required object attribute Id. */
public interface ICFIntPubLicenseHPKey
{
